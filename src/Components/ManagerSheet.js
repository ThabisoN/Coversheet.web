...
import printPDF from '../Data/PrintPDF';
...
export class ManagerSheet extends Component {
    constructor(props) {
        super(props);
    ...
    editClick(st) {
        this.setState({
            modalTitle: "Platinum Life Cover Sheet",
    ...
    generatePDF() {
        ...
        html2canvas(input)
            .then((canvas) => {
                ...
                const pdf = new jsPDF();
                pdf.addImage(imgData, 'JPEG', 10, 20, 310, 297);
                pdf.save("CoverSheet.pdf");
            });
    }
                    ...
                    <tbody>
                        {sheets.map(st =>
                            <tr key={st.Sheet_Id}>
                                ...
                                <td>{st.Lastname}</td>
                                <td>{st.Department}</td>
                                <td>{Moment(st.Invoice_Date).format('YYYY-MM-DD')}</td>
                                <td>{Moment(st.Payment_Date).format('YYYY-MM-DD')}</td>
                                <td>{st.Supplier}</td>
                                ...
                                <td>
                                    ...
                                    <button type="button" className='btn btn-light mr-1'
                                        onClick={() => this.deleteClick(st.Sheet_Id)}>
                ...
                <div className="modal fade" id="exampleModal" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog modal-lg modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div id="divToPrint" className="modal-body">
                                <div className="modal-header">
                                ...
                                <div className="d-flex flex-row bd-highlight mb-3">
                                    ...
                                    <div className="p-2 w-50 bd-highlight">
                                        ...
                                        <div className="input-group mb-3">
                                            <span className="input-group-text">Name and Surname</span>
                                            <select className="form-select"
                                                onChange={this.changeFullname}
                                                value={Fullname}>
                                                {managers.map(man => <option key={man.Manager_Id}>
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <select className="form-select"
                                                ...
                                                value={Manager}>
                                                {managers.map(man =>
                                                    <option key={man.Manager_Id}>
                                                        {man.Manager_Signature}
                                                    </option>)}
                                            </select>
                                        </div>
                                        <div className="input-group mb-3">
                                ...
                                {Sheet_Id != 0 ?
                                    <button type="button"
                                        className="btn btn-primary float-start"
                                        onClick={() => this.callDoubleButtons()}>Update and SignOff</button> : null}
                            </div>
                        </div>
                    </div>
                </div>
